...
- Campaign IDs, titles, QA labels, scene lookup, and transition order now live in `scripts/level_catalog.gd`; network snapshots retain `level_path` until a dedicated protocol migration.
