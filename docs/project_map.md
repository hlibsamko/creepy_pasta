...
- Campaign IDs, titles, QA labels, scene lookup, transition order, and authoritative exit positions now live in `scripts/level_catalog.gd`; network snapshots retain `level_path` until a dedicated protocol migration.
