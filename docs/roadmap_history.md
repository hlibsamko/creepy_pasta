# Creepy Pasta Roadmap — Archived Previous Version

**ARCHIVE ONLY. Do not use this file to choose current work.** The complete previous `roadmap.md` is preserved below unchanged for historical context. Current priority lives in `docs/roadmap.md`.
